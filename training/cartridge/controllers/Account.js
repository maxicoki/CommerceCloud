...
function editProfile() {
	...
	var log=Logger.getLogger('maxi', 'newsletter');
	
	var myForm = session.forms.profile;
	
	log.debug('Valor campo nuevo (custom): '+ myForm.customer.emaillist.value);
	//log.debug('Valor campo antiguo: '+ myForm.customer.addtoemaillist.value);
	log.debug('Valor firstname: '+ myForm.customer.firstname.value);
